...
import numpy as np
import xarray as xr
from message_ix_buildings.chilled.functions.variable_dicts import VARS_ARCHETYPES  # type: ignore
from message_ix_buildings.chilled.preprocess.message_raster import create_message_raster  # type: ignore
